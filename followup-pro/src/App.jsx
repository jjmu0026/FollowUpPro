...
import { Plus, Mail, Clock, CheckCircle, XCircle, AlertCircle } from 'lucide-react'
...
function App() {
  ...
  const addJob = async (job) => {
    ...
    setJobs([...jobs, {
      ...data[0],
      // Optionally map snake_case back to camelCase if needed
      appliedAt: data[0].applied_at,
      lastContactedAt: data[0].last_contacted_at,
      recruiterEmail: data[0].recruiter_email,
    }]);
        ...
        <>
          <header className="py-12 px-4 flex flex-col items-center">
            <div className="flex items-center gap-3 mb-4">
              <img src={viteLogo} alt="FollowUpPro Logo" className="w-14 h-14 rounded-full shadow" />
            ...
            <p className="text-xl text-gray-600 max-w-2xl text-center mb-8">
              The smart, stress-free way to track your job applications and follow up with recruiters at the perfect time.
            </p>
            <button
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center py-6">
                <div className="flex items-center gap-3">
                  <img src={viteLogo} alt="FollowUpPro Logo" className="w-10 h-10 rounded-full shadow" />
                  <div>
